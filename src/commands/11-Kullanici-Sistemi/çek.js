...
run: async (client, message, args, embed, prefix) => {
  ...
  let ramalayar = await serverSettings.findOne({
  ...
  if (message.member.permissions.has("ADMINISTRATOR")) {
    ...
    message.guild.channels.cache.get(ramalayar.voiceLogChannel).wsend(log);
} else {
...
let msg = await message.channel.send((member.toString()), { components : [ row ], embed: ramal})
