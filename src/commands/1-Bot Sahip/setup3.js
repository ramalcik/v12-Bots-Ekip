...
`)
        ...
        if(["chatChannel","chat"].some(x => x === choose)) {
            ...
            ramal.chatChannel = log.id, await ramal.save(), message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu chatChannel başarıyla ${log} olarak ayarlandı`, message.author, message.channel))
        };
        ...
        if(["kurallar"].some(x => x === choose)) {
            ...
            ramal.kurallar = log.id, await ramal.save(), message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu kurallar başarıyla ${log} olarak ayarlandı`, message.author, message.channel))
        };
        ...
        if(["cezapuanlog"].some(x => x === choose)) {
            ...
            ramal.cezapuanlog = log.id, await ramal.save(), message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu cezapuanlog başarıyla ${log} olarak ayarlandı`, message.author, message.channel))
        };
        ...
        if(["invLogChannel","invite"].some(x => x === choose)) {
            ...
            ramal.invLogChannel = log.id, await ramal.save(), message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu invLogChannel başarıyla ${log} olarak ayarlandı`, message.author, message.channel))
        };
        ...
        if(["teyitKanali","register"].some(x => x === choose)) {
            ...
            ramal.teyitKanali = log.id, await ramal.save(), message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu teyitKanali başarıyla ${log} olarak ayarlandı`, message.author, message.channel))
        };
        ...
        if(["toplantiSesChannel"].some(x => x === choose)) {
            ...
            ramal.toplantiSesChannel = log.id, await ramal.save(), message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu toplantiSesChannel başarıyla ${log} olarak ayarlandı`, message.author, message.channel))
        };
