...
const inviterData = await inviterSchema.findOne({ guildID: message.guild.id, userID: member.user.id });
    ...
    var yukselt = new  MessageButton()
    .setLabel("yükselt")
    .setID("adoş_button")
    .setStyle("blurple")
    .setEmoji("990262923580563538")
    //.setEmoji("915754670931193917")
    ...
    .setID("iptal_button")
    .setStyle("red")
    .setEmoji("990262953121042432")
    //.setEmoji("915754675742081076")
    const row = new MessageActionRow()
    .addComponents(PuanDetaylari, GenelPuanDetaylari, Iptal, yukselt)
embed.setThumbnail(message.author.avatarURL({ dynamic : true}))
embed.setDescription(`
${member.toString()} (${member.roles.highest}) kullanıcısının yetki yükseltim bilgileri aşağıda verilmiştir .
${star} **Puan Durumu:**
